        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Cartid = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CustomreId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_shoppingCarts", x => x.Cartid);
                    table.ForeignKey(
                        name: "FK_shoppingCarts_customers_CustomreId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Comment = table.Column<string>(type: "nvarchar(130)", maxLength: 130, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_shoppingCarts_CustomreId",
                table: "shoppingCarts",
                column: "CustomreId");
        }
